...
export declare class MeasureToken extends Token {
    ...
    static create(version: DesignSystemVersion, brand: Brand, name: string, description: string, value: string, alias: MeasureToken | null, properties: Array<ElementProperty>, propertyValues: Array<ElementPropertyValue>): MeasureToken;
