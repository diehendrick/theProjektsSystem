...
export declare class TokenJSONElementFigmaTokensTransformer extends TokenJSONElementTransformer {
    ...
    typeLabelConsideringAbstractGroups(token: Token): "color" | "fontSize" | "letterSpacing" | "lineHeight" | "paragraphSpacing" | "border" | "font" | "gradient" | "radius" | "shadow" | "text" | "typography" | "sizing" | "borderRadius" | "borderWidth" | "spacing" | "opacity";
     ...
     */
    safeGroupName(group: TokenGroup, naming: JSONBuilderNamingOption): string;
    /** Create full reference name representing token. Such name can, for example, look like: [g1].[g2].[g3].[g4].[token-name] */
    referenceName(token: Token, allGroups: Array<TokenGroup>, options: TokenJSONBuilderOptionsInternal): string;
