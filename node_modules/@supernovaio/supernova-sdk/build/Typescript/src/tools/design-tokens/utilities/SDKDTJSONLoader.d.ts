...
export declare class DTJSONLoader {
    themeBuffer: Array<DTParsedTheme>;
    constructor();
    /** Load token definitions from path */
    loadDSObjectsFromTokenFile(pathToFile: string): Promise<object>;
    loadDSObjectsFromTokenFileDirectory(pathToDirectory: string): Promise<object>;
