...
export declare class DataCore {
    ...
    private tokenMutex;
    private tokenGroupMutex;
    private themesMutex;
    private componentMutex;
    private designComponentAssetMutex;
    private designComponentAssetGroupMutex;
    private documentationItemMutex;
    private configurationMutex;
    private exporterCustomBlocksMutex;
    private tokens;
    private tokenGroups;
    private themes;
    private components;
    ...
    currentDesignSystemTokens(designSystemId: string, designSystemVersion: DesignSystemVersion): Promise<Array<Token>>;
